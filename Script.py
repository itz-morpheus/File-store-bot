...
class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},ᴍʏ ɴᴀᴍᴇ {},ɪ ᴀᴍ ʟᴀᴛᴇꜱᴛ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀɴᴅ ᴘᴏᴡᴇʀꜰᴜʟ ꜰɪʟᴇ ꜱᴛᴏʀᴇ | sᴛʀᴇᴀᴍ | ᴅᴏᴡɴʟᴏᴀᴅ ʙᴏᴛ</b>"""

    CAPTION = """<b>📂 ғɪʟᴇɴᴀᴍᴇ : {file_name}

sɪᴢᴇ ⚙️: {file_size}

Jᴏɪɴ [ᴄʜᴀɴɴᴇʟ](https://t.me/Ashlynn_Repository)</b>""" 
...
ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛʜɪs ғᴇᴀᴛᴜʀᴇ ᴛʜᴇɴ ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ᴏᴡɴ ᴄʟᴏɴᴇ ʙᴏᴛ ғʀᴏᴍ ᴍʏ <a href=https://t.me/vj_botz>ᴘᴀʀᴇɴᴛ</a></b>"""
    ...
    ABOUT_TXT = """<b>ʜɪ ɪ ᴀᴍ ᴘᴇʀᴍᴀɴᴇɴᴛ ғɪʟᴇ sᴛᴏʀᴇ | sᴛʀᴇᴀᴍ | ᴅᴏᴡɴʟᴏᴀᴅ ʙᴏᴛ
...
"""
    ...
    CABOUT_TXT = """<b>ʜɪ ɪ ᴀᴍ ᴘᴇʀᴍᴀɴᴇɴᴛ ғɪʟᴇ ꜱᴛᴏʀᴇ | sᴛʀᴇᴀᴍ | ᴅᴏᴡɴʟᴏᴀᴅ ʙᴏᴛ
...
🧑🏻‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ: <a href=https://t.me/Ashlynn_Repository>ᴅᴇᴠᴇʟᴏᴘᴇʀ</a></b>
"""
